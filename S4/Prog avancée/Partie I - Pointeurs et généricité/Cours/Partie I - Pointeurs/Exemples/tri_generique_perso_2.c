...
static 
int comparer_int_cb( void * i1 , void * i2 )
{
  return( comparer_int( (int *)i1 , (int *)i2 ) ) ;
}
...
static
int comparer_str_cb( void * s1 , void * s2 )
{
...
main()
{
  ...
  tri( tab_i , 10 , sizeof(int) , comparer_int_cb ) ;
  ...
  tri( tab_s , 5 , sizeof(char *) , comparer_str_cb ) ;
