...
{
  if(obj1_existe(*obj1)) {
  /* On free les attributs des objets puis les objets, et ensuite on met le pointeur sur NULL pour �viter tout probl�me de pointeur fou ou tentative de free l'objet une seconde fois */
    free((*obj1)->attributs);
    free(*obj1);
